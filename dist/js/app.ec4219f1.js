(function (t) {
  function e(e) {
    for (
      var a, i, n = e[0], d = e[1], l = e[2], u = 0, m = [];
      u < n.length;
      u++
    )
      (i = n[u]),
  ...
  "56d7": function (t, e, s) {
    ...
    var a,
                      ...
                      a(
                        ...
                        [
                          ...
                          a(
                            ...
                            [
                              ...
                              a("div", { staticClass: "mt-3" }, [
                                t._v("Selected: "),
                                a("strong", [
                                  t._v(t._s(t.addJobForm.attack_mode)),
                                ]),
                              ]),
                            ],
                            1
                          ...
                          a("div", { staticClass: "mt-3" }, [
                            t._v("Selected: "),
                            a("strong", [
                              t._v(t._s(t.addJobForm.hash_mode.id)),
                            ]),
                          ]),
                          a("br"),
                          a(
                            ...
                            [
                              a("b-form-select", {
                                attrs: {
                                  ...
                                  "select-size": 1,
                                  placeholder:
                                    "Select Mask File for Brute Mode",
                                },
                                model: {
                              ...
                              a(
                                  ...
                                  directives: [
                                    {
                                      ...
                                      rawName: "v-b-popover.hover",
                                      value:
                                        "Optional timeout value for the job in hours, default is set to 3 weeks",
                                      expression:
                                        "'Optional timeout value for the job in hours, default is set to 3 weeks'",
                                      modifiers: { hover: !0 },
                                    },
                                ...
                                [
                                  ...
                                  a("div", [
                                    a("strong", [
                                      t._v(
                                        t._s(t.addJobForm.timeout) + " hour/s"
                                      ),
                                    ]),
                                  ]),
                                ],
              ...
              [
                s(
                  ...
                  [
                    s(
                      "b-tab",
                      { attrs: { align: "center", title: "Cracked" } },
                      [
                    ...
                    s(
                      "b-tab",
                      { attrs: { align: "center", title: "Job Details" } },
                      [
                        s("table", [
                          401 == t.job_details
                            ? s("td", [t._v("Unauthorized ")])
          ...
          getJob: function (t) {
            ...
            (this.loading = !0),
              v.a
                ...
                .catch(function (t) {
                  (e.loading = !1),
                    (e.job_details = t.response.status),
                    t.response &&
        ...
        methods: {
          ...
          timedAlert: function () {
            ...
            this.$swal({
              ...
              customClass: { loader: "spinner-border" },
              willClose: function () {
                t.getQueue();
              },
            });
                ...
                if (
                  ...
                  if (e.data["Current Job"][l].State["HC State"]) {
                    ...
                    for (
                      a.push(m - b),
                        a.push(b),
                        o = e.data["Current Job"][l].State["Speed Array"],
                        o.push(e.data["Current Job"][l].State["Speed Array"]),
                        d =
                          e.data["Current Job"][l].State["HC State"][
                            "Speed All"
                          ],
            ...
            v.a
              ...
              .then(function (e) {
                (t.options = e.data),
                  ...
                  (t.addJobForm.timeout =
                    Number(t.options.timeout.Value) / 3600),
                  (t.disable_timeout = Boolean(t.options.timeout.Modify)),
            ...
            a("div", { staticClass: "row" }, [
              a(
                ...
                [
                  ...
                  a("br"),
                  a("br"),
                  a("b-card", { staticClass: "crackq text-center" }, [
              ...
              .then(function (s) {
                200 === s.status
                  ? ((e.message = "Deleted"),
                    ...
                    e.getQueue())
                  : 204 === s.status &&
                    ((e.message = "Deleting Job: ".concat(t, "\r\n")),
      ...
      Qt = {
        ...
        components: { showProfile: it, showAdmin: tt },
        methods: {
          showAlert: function (t) {
            this.$swal({
              text: this.message,
        ...
        methods: {
          ...
          getReport: function (t) {
            ...
            v.a
              ...
              .then(function (t) {
                (e.report = t.data),
                  Object(Gt["a"])("#vis1", e.report.topx_chart),
                  Object(Gt["a"])("#vis2", e.report.len_chart),
                  Object(Gt["a"])("#vis3", e.report.base_chart),
                  Object(Gt["a"])("#vis4", e.report.country_chart),
                  Object(Gt["a"])("#vis5", e.report.city_chart),
                  Object(Gt["a"])("#vis6", e.report.city_gps_chart);
              })
              .catch(function (t) {
          ...
          renderReport: function () {
            ...
            this.getReport(t),
              Object(Gt["a"])("#vis1", this.report.topx_chart),
              Object(Gt["a"])("#vis2", this.report.len_chart),
              Object(Gt["a"])("#vis3", this.report.base_chart);
          },
        },
        created: function () {
      ...
      te =
        (s("f0f9"),
        s("e32b"),
        Object(w["a"])(Vt, Wt, Yt, !1, null, "0077eb6f", null)),
      ee = te.exports,
      se = function () {
        var t = this,
          e = t.$createElement,
        ...
        methods: {
          showAlert: function (t) {
            this.$swal({
              ...
              showConfirmButton: !1,
              buttonsStyling: !1,
              confirmButtonClass: "btn-sm w-25",
          ...
          getBenchmarks: function () {
            ...
            v.a
              ...
              .then(function (e) {
                ...
                var s = [],
                  a = [];
                for (var o in ((t.benchmarks = e.data.Benchmarks),
                e.data.Benchmarks))
                  "2000" !== o && (s.push(o), a.push(e.data.Benchmarks[o][0]));
                t.bench_data = {
                  labels: s,
                  datasets: [
                    {
    ...
    var de = new x["a"]({
      ...
      routes: [
        ...
        { path: "/complete", name: "Complete", component: Bt },
    ...
    m["default"].use(f.a),
      m["default"].use(l["a"]),
      m["default"].use(b["default"]),
      (m["default"].config.productionTip = !1),
      m["default"].component("multiselect", u.a),
      (v.a.defaults.xsrfCookieName = "csrftoken"),
      (v.a.defaults.xsrfHeaderName = "X-CSRFTOKEN"),
      new m["default"]({
        router: de,
